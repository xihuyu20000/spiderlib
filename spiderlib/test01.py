...
def test_MySQLPipeline1():
    ...
    spider.page(expresses={"title":"//a[@id='cb_post_title_url']//text()", "content":"//div[@id='cnblogs_post_body']//text()"}, fields_tag='../b.txt', fields={"标题":'title', "正文":"content"}, is_list=False)
    spider.run()
